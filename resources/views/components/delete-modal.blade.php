@props(['name', 'title' => 'Konfirmasi Hapus', 'message' => 'Apakah Anda yakin ingin menghapus data ini?'])
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="text-sm text-red-600 font-semibold mt-1">Data akan dihapus secara permanen.</p>
                        </div>
                    </div>
                </div>
            </div>
